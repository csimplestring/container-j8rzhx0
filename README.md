...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j8rzhx0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j8rzhx0.containers.anotherwebservice.com/
...
```
git clone git@github.com:csimplestring/container-j8rzhx0.git
cd container-j8rzhx0
```
...
```
docker attach container-j8rzhx0
```
